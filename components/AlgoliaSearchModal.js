  ...
  return <div id='tags-group' className='dark:border-gray-700 space-y-2'>
            {
                firstTenTags?.map((tag, index) => {
                  return <Link passHref
                        ...
                        <div className={' flex items-center text-black dark:text-gray-300 hover:bg-blue-600  hover:scale-110 hover:text-white rounded-lg px-2 py-0.5 duration-150 transition-all'}>
