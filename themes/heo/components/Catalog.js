...
const Catalog = ({ toc }) => {
  ...
  return <div className='py-1 dark:text-gray-500 text-black'>
    <div className='w-full text-sm font-normal'><i className='mr-1 fas fa-stream' />{locale.COMMON.TABLE_OF_CONTENTS}</div>
