...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'medium', // 主题， 支持 ['matery','next','hexo',"fukasawa','medium','example'] @see https://preview.tangly1024.com
  ...
  BACKGROUND_DARK: '#151922', // use hex value, don't forget '#'
