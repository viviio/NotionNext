...
const Header = props => {
  ...
  return (
    <>
      ...
      <nav
        id='nav'
        className={`z-20 h-16 bottom-0 w-full duration-300 transition-all 
            ${fixedNav ? 'fixed' : 'fixed'} 
            ${textWhite ? 'text-white ' : 'text-black dark:text-white'}  
            ${navBgWhite ? 'bg-white dark:bg-[#18171d] shadow' : 'bg-white dark:bg-[#18171d] shadow'}`}>
